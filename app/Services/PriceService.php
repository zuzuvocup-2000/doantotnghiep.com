...
class PriceService implements PriceServiceInterface
{
   ...
   public function pagination($page){
      ...
      $config = pagination_config_bt(['url' => convertUrl('backend.product.price.index'),'perpage' => $perpage], $config);
   ...
   public function delete($price){
      $this->db->transBegin();
      try{
         $this->priceRepository->deleteById($price['id']);
   ...
   private function store($param = []){
		...
		$store = [
 			...
 			'price_min' => priceConvert($this->request->getPost('price_min')),
 			'price_max' => priceConvert($this->request->getPost('price_max')),
