...
class ProductCatalogueService implements ProductCatalogueServiceInterface
{
   ...
   public function __construct($param){
      ...
      $this->productCatalogueRepository = service('ProductCatalogueRepository', 'product_catalogue');
      helper(['mystring']);
   }
   ...
   public function pagination($page){
      ...
      'join' =>  [
         [
            'product_translate as tb2','tb1.id = tb2.objectid AND tb2.module = \''.$this->module.'\'   AND tb2.language = \''.$this->language.'\' ','inner'
         ],
      ],
      'keyword' => $keyword,
      'where' => $where,
