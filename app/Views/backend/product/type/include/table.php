<table class="table table-striped table-bordered table-hover dataTables-example">
   ...
   <tbody>
        <?php if(isset($type['list']) && is_array($type['list']) && count($type['list'])){ ?>
        <?php foreach($type['list'] as $key => $val){ ?>
        <?php
        ...
        <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
           ...
           <td class="text-success text-bold">
               <a href="<?php echo base_url(convertUrl('backend.product.type.update.').$val['id'].'') ?>">
               <?php echo $val['title']; ?>
               </a>
            </td>
           ...
           <td class="text-center">
                <a type="button" href="<?php echo base_url(convertUrl('backend.product.type.update.'.$val['id'])) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                <a type="button" href="<?php echo base_url(convertUrl('backend.product.type.delete.'.$val['id'])) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
           </td>
        </tr>
        <?php }}else{ ?>
           <tr>
...
<div id="pagination">
   <?php echo (isset($type['pagination'])) ? $type['pagination'] : ''; ?>
</div>
