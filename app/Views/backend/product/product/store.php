		...
		<div class="row">
            ...
            <div class="ibox mb20">
               ...
               <div class="ibox-content">
                  <?php echo view(convertUrl('backend.product.product.include.general')) ?>
               </div>
            </div>
			   <?php echo view(convertUrl('backend.product.product.include.gallery')) ?>
			   <?php echo view(convertUrl('backend.product.product.include.seo')) ?>
				<button type="submit" name="create" value="create" class="btn btn-primary block m-b pull-right">Lưu</button>
			</div>
			<div class="col-lg-3">
            <?php echo view(convertUrl('backend.product.product.include.aside')) ?>
			</div>
		</div>
	</div>
</form>
