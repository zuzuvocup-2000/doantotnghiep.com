<table class="table table-striped table-bordered table-hover dataTables-example">
   ...
   <tbody>
        <?php if(isset($productCatalogue['list']) && is_array($productCatalogue['list']) && count($productCatalogue['list'])){ ?>
        <?php foreach($productCatalogue['list'] as $key => $val){ ?>
        <?php
        ...
        <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
           ...
           <td <?php echo ($val['level'] == 1) ? 'class="text-success text-bold"' : '' ?>>
               <a href="<?php echo base_url(convertUrl('backend.product.catalogue.update.').$val['id'].'') ?>">
           ...
           <td class="text-center">
                <a type="button" href="<?php echo base_url(convertUrl('backend.product.catalogue.update.'.$val['id'])) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                <a type="button" href="<?php echo base_url(convertUrl('backend.product.catalogue.delete.'.$val['id'])) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
           </td>
        </tr>
        <?php }}else{ ?>
           <tr>
...
<div id="pagination">
   <?php echo (isset($productCatalogue['pagination'])) ? $productCatalogue['pagination'] : ''; ?>
</div>
