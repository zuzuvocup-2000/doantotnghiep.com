   ...
   <div class="ibox-content">
      <div class="row">
         <div class="col-lg-12">
            ...
            <div class="form-row">
               <?php echo form_dropdown('parentid', $config['dropdown'], set_value('parentid', (isset($productCatalogue['parentid'])) ? $productCatalogue['parentid'] : ''), 'data-module= "'.$config['module'].'" class="form-control m-b select2"');?>
            </div>
         </div>
      </div>
   </div>
