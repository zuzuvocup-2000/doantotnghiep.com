			...
			<div class="col-lg-9 clearfix">
				<div class="ibox mb20">
					...
					<div class="ibox-content">
					   <?php echo view_fix('backend.project.type.include.general') ?>
					</div>
				</div>
				<?php //view_fix('backend.project.type.include.gallery') ?>
				<?php //view_fix('backend.project.type.include.seo') ?>
				<button type="submit" name="create" value="create" class="btn btn-primary block m-b pull-right">Lưu</button>
			</div>
			<div class="col-lg-3">
			   <?php echo view_fix('backend.project.type.include.aside') ?>
			</div>
		</div>
	</div>
</form>
