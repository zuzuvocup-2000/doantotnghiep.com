<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Xóa thành viên: <?php echo $member['fullname'] ?></h2>
		<ol class="breadcrumb">
			<li>
						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('email', set_value('email', $member['email']), 'class="form-control" disabled placeholder="" autocomplete="off"');?>
									<?php echo form_hidden('id', set_value('id', $member['id']), 'class="form-control " placeholder="" autocomplete="off"');?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('fullname', set_value('fullname', $member['fullname']), 'class="form-control " placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
						</div>
						<div class="row mb15">
								...
								<div class="form-row">
									<label class="control-label text-left">
									 ...
									 <?php
                                        ...
                                        echo form_dropdown('gender', $gender, set_value('gender', $member['gender']),'class="form-control mr20 input-sm perpage filter" style="width:100%" disabled'); 
                                    ?>
								</div>
							</div>
						</div>
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('birthday', set_value('birthday', $member['birthday']), 'class="form-control datetimepicker" placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('address', set_value('address', $member['address']), 'class="form-control " placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('phone', set_value('phone', $member['phone']), 'class="form-control " placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
						</div>
