						...
						<div class="row mb15">	
							<div class="col-lg-6">
								<div class="form-row">
									...
									?>
									<?php echo form_dropdown('catalogueid', $userCatalogue, set_value('catalogueid', (isset($user['catalogueid'])) ? $user['catalogueid'] : ''), 'class="form-control  "');?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('job', set_value('job', (isset($user['job'])) ? $user['job'] : ''), 'class="form-control" placeholder="" autocomplete="off" ');?>
								</div>
							</div>
						...
						<div class="row mb15">
							<div class="col-lg-6">
								...
								<div class="form-row">
									...
									?>
									<?php echo form_dropdown('cityid', $city, set_value('cityid', (isset($user['cityid'])) ? $user['cityid'] : 0), 'class="form-control  city"  id="city"');?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
									...
									<select name="districtid" id="district" class="form-control  location">
						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<select name="wardid" id="ward" class="form-control  location">
