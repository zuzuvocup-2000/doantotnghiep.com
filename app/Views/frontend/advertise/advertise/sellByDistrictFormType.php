       ...
       <div class="project-container">
            <div class="project-container-head">
                <div class="uk-grid uk-grid-small">
                        ...
                        <div class="main-project">
                            <div class="panel-breacum">
                                <ul class="uk-list uk-clearfix uk-flex">
                                    ...
                                    <li><a href="<?php echo $canonical ?>" title="Cần bán nhà đất tại <?php echo $districtDetail['name'] ?>">Cần bán nhà đất tại <?php echo $districtDetail['name'] ?></a></li>
                                </ul>
                            </div>
                            <?php $now = date("Y/m/d");  ?>
                            <?php $direction = DIRECTION;  ?>
                            <h1 class="heading-1"><span><?php echo ($form == 0 || $form == 1) ? 'Cần bán' : 'Cần cho thuê'; ?> <?php echo $productTypeDetail['title'] ?> tại <?php echo $districtDetail['name'] ?></span></h1>
                    ...
                    <script>
                       var cityid = '<?php echo (isset($_POST['city_id'])) ? $_POST['city_id'] : $districtDetail['provinceid']; ?>';
                       var districtid = '<?php echo (isset($_POST['district_id'])) ? $_POST['district_id'] : $districtDetail['districtid']; ?>'
                       var wardid = ''
                    </script>
                                ...
                                <form action="">
                                    ...
                                    <div class="uk-grid uk-grid-small">
                                        ...
                                        <div class="uk-width-small-1-1 uk-width-medium-1-2">
                                           <div class="search-col">
                                                <div class="form-field uk-flex uk-flex-middle uk-flex-space-between">
                                                     <?php echo form_dropdown('type', $productType, set_value('type', (isset($productTypeDetail['id'])) ? $productTypeDetail['id'] : ''), ' class="property-type"');?>
                                                </div>
                                                <div class="form-field uk-flex uk-flex-middle uk-flex-space-between">
