                          ...
                          <div class="main-plan">
                              <div class="panel-breacum">
                                  <ul class="uk-list uk-clearfix uk-flex">
                                      ...
                                      <li><a href="<?php echo write_url($canonical) ?>" title="">Danh sách dự án tại <?php echo $detailCity['name']; ?> </a></li>
                                  </ul>
                              </div>
                              ...
                              <div class="list-plan">
                                  <h2 class="heading-2"><span>Danh sách dự án tại <?php echo $detailCity['name'] ?>
                                  </span></h2>
                                  <?php if(isset($project['list']) && is_array($project['list']) && count($project['list'])){ ?>
                                 <?php foreach($project['list'] as $key => $val){ ?>
