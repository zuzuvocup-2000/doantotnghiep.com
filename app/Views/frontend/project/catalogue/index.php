                  ...
                  <div class="uk-grid uk-grid-small">
                      <div class="uk-width-small-1-1 uk-width-medium-2-3">
                          <div class="main-plan">
                                         ...
                                         <?php foreach($articleList as $key => $val){ ?>
                                          ...
                                          <div class="uk-width-small-1-1 uk-width-medium-1-3">
                                              <div class="plan-article-item">
                                                  <div class="thumb"><a href="<?php echo write_url($val['canonical']) ?>" class="image img-cover"><img src="<?php echo $val['image'] ?>" alt="<?php echo $val['title'] ?>"></a></div>
                                                  <div class="info">
                                                      <h3 class="title"><a href="<?php echo write_url($val['canonical']) ?>" title="<?php echo $val['district']; ?>"><?php echo $val['district']; ?></a></h3>
                              ...
                              <div class="list-plan">
                                  <h2 class="heading-2"><span>DANH SÁCH DỰ ÁN BẤT ĐỘNG SẢN</span></h2>
                                  <?php if(isset($articleList) && is_array($articleList) && count($articleList)){ ?>
                                 <?php foreach($articleList as $key => $val){ ?>
                      ...
                      <div class="uk-width-small-1-1 uk-width-medium-1-3">
                          <div class="aside-plan">
                                  ...
                                  <h4 class="title"><span>Tìm kiếm dự án</span></h4>
                                   <form action="<?php echo site_url('frontend/project/catalogue/findProjectByType') ?>" class="content" method="get">
                                      <div class="form-field">
                                          <input type="text" id="projectname" name="keyword" maxlength="100" placeholder="Nhập tên cần tìm" autocomplete="off" />
                                      </div>
                                      <div class="form-field">
                              ...
                              <div class="aside-plan-list">
                                  ...
                                  <?php if(isset($projectType) && is_array($projectType) && count($projectType)){ ?>
                                  <ul class="uk-list uk-clearfix">
                                    <?php foreach($projectType as $key => $val){ ?>
