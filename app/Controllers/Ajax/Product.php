...
class Product extends BaseController{
	...
	public function getAttribute(){
      ...
      $attributeCataloge = json_decode($data['attribute_catalogue']);
      $attributeCataloge = explode(',', $attributeCataloge);

      echo json_encode($attributeCataloge);
   }
