...
class ConfigBie{
	...
	public function system(){
		...
		$data['post'] =  array(
			'label' => 'Cấu hình tin đăng',
			'description' => 'Một số cấu hình được thêm vào tại đây',
			'value' => array(
				'vip' => array('type' => 'editor', 'label' => 'Lợi ích của VIP'),
				'link' => array('type' => 'editor', 'label' => 'Các trang rao vặt hiệu quả khác'),
				'help' => array('type' => 'editor', 'label' => 'Hướng dẫn nạp tiền vào tài khoản'),
				'delete' => array('type' => 'editor', 'label' => 'Tin của bạn sẽ không được duyệt hoặc bị xóa nếu'),
				'best' => array('type' => 'editor', 'label' => 'Hướng đăng tin hiệu quả'),
			),
		);
		$data['seo'] =  array(
